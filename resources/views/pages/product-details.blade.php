                            ...
                            <form action="{{ route('buynow.product') }}" method="post">
                                ...
                                <div class="product-details">
                                    ...
                                    <div class="ratings-container">
                                        ...
                                        <a class="ratings-text" href="#product-review-link" id="review-link">( 200
                                            Reviews )</a>
                                        ...
                                        <div class="product-nav product-nav-thumbs">
                                            <select name="product_color" id="product_color" required class="form-control">
                                                ...
                                                @foreach ($product_details->flatMap->product_varient->flatMap->colors as $colorNew)
                                                    <option value="{{ $colorNew->color_name }}">{{ $colorNew->color_name }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    ...
                                    <div class="product-details-action">
                                        ...
                                        <div class="details-action-wrapper">
                                            ...
                                            <div class="details-action-wrapper">
                                                <button href=""
                                                    class="btn btn-success btn-product btn-cart text-white "
                                                    title="Buynow"><span> Buy Now</span></button>
                    ...
                    <ul class="nav nav-pills justify-content-center" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link active" id="product-desc-link" data-toggle="tab" href="#product-desc-tab"
                                role="tab" aria-controls="product-desc-tab" aria-selected="true">Sort
                                Description</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" id="product-info-link" data-toggle="tab" href="#product-info-tab"
                                role="tab" aria-controls="product-info-tab" aria-selected="false">Long
                                Description</a>
                        </li>
                        <li class="nav-item">
                ...
                <div class="product product-11 mt-v3 text-center product_data">
                    <figure class="product-media">
                        ...
                        <a href="{{ route('product.details', $cat_prouct->id) }}">
                            <img src="{{ asset($cat_prouct->product_img_one) }}"
                                alt="{{ $cat_prouct->product_name }}" class="product-image">
                            <img src="{{ asset($cat_prouct->product_img_two) }}" alt=""
                                class="product-image-hover">
                        </a>
                        <div class="product-action-vertical">
                            <a href="{{ url('add/wishlist/' . $cat_prouct->id) }}"
                    ...
                    <div class="product-body">
                        <h3 class="product-title"><a
                                href="{{ route('product.details', $cat_prouct->id) }}">{{ $cat_prouct->product_name }}
        ...
        @foreach ($cat_product as $cat_prouct)
            <div class="product product-7 text-center">
                <figure class="product-media">
                    ...
                    <a href="{{ route('product.details', $cat_prouct->id) }}">
                        <img src="{{ asset($cat_prouct->product_img_one) }}" alt="{{ $cat_prouct->product_name }}"
                            class="product-image">
                    </a>
                    <div class="product-action-vertical">
                    ...
                    <div class="product-action">
                        ...
                        <a href="{{ route('product.details', $cat_prouct->id) }}"
                            class="btn-product btn-cart"><span>BUY NOW</span></a>
                    </div>
                </figure>
                <div class="product-body">
                    <h3 class="product-title"><a
                            href="{{ route('product.details', $cat_prouct->id) }}">{{ $cat_prouct->product_name }}</a>
