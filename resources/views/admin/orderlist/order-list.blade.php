                          ...
                          <table id="datatable1" class="table display responsive nowrap">
                            <thead>
                              <tr>
                                ...
                                <th class="wd-20p">Payement Status</th>
                            ...
                            <tbody>
                              ...
                              <tr>
                                ...
                                <td>
                                  ...
                                  <a class="badge badge-primary" href="{{ $order->stripe_url }}" target="_blank"> Payment invoice
                                  </a>
                                  @endif
                                </td>
                                <td>${{ $order->subtotal }}</td>
                                <td>${{ $order->copon_discount??0 }}</td>
                                <td>${{ $order->total }}</td>
                                <td>
                                ...
                                <td style="width:10%;">
                                  <a style="font-size:18px; " href="{{ url('oreder/details',$order->id) }}" class="btn btn-outline-primary btn-sm" title="Order Detail">
                                  <i class="icon ion-ios-eye"></i>
                                  </a>
                                  <a href="{{ url('generate-pdf',$order->id) }}" target="_blank" title="Print Invoice" class="btn btn-outline-success btn-sm">
                                  ...
                                  <a href="{{ url('/order-hidden',$order->id) }}" title="Delete order" class="btn btn-outline-danger btn-sm">
