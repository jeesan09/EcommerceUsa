                        ...
                        <div class="form-tab">
                            ...
                            <div class="card-body mt-2">
                                <form method="POST" action="{{ route('register') }}">
                                    ...
                                    <div class="form-group row">
                                        <label for="name" class="col-md-12 col-form-label text-md">Company Name
                                            *</label>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea id="shipping_address" class="form-control @error('shipping_address') is-invalid @enderror"
                                            name="shipping_address" rows="4" required>{{ old('shipping_address') }}</textarea>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea id="billing_address" class="form-control @error('billing_address') is-invalid @enderror"
                                            name="billing_address" rows="4" required>{{ old('billing_address') }}</textarea>
